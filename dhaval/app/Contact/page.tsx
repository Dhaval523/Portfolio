      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="group">
                  <input
                    ...
                    required
                    className="w-full bg-gray-500/5 border border-gray-700 rounded-xl px-4 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-[var(--primary-color)] focus:bg-gray-500/10 transition-all duration-300 group-hover:border-gray-600"
                  />
                </div>
                <div className="group">
                  <input
              ...
              <div className="group">
                <select
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full bg-gray-500/5 border border-gray-700 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-[var(--primary-color)] focus:bg-gray-500/10 transition-all duration-300 group-hover:border-gray-600 appearance-none cursor-pointer"
                >
              ...
              <div className="group">
                <textarea
                  ...
                  required
                  className="w-full bg-gray-500/5 border border-gray-700 rounded-xl px-4 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-[var(--primary-color)] focus:bg-gray-500/10 transition-all duration-300 group-hover:border-gray-600 resize-none"
                ></textarea>
              </div>
        ...
        <div className={`space-y-8 transform transition-all duration-1000 delay-400 ${
          ...
          <div className="space-y-6">
            ...
            {contactInfo.map((item, index) => (
              ...
              >
                ...
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 text-gray-400 group-hover:bg-[var(--primary-color)] group-hover:text-white transition-all duration-300">
          ...
          <div className="pt-6 border-t border-gray-700">
            <h4 className="text-xl font-unbounded font-semibold text-white mb-6">
              Follow Me On
            </h4>
